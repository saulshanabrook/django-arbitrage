...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StockGroup.other_side'
        db.add_column('stocks_stockgroup', 'other_side',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'StockGroup.other_side'
        db.delete_column('stocks_stockgroup', 'other_side')
